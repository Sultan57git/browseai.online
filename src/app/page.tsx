          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-8">
              ...
              <nav className="hidden md:flex items-center space-x-6">
                <a href="/tools" className="flex items-center space-x-2 text-blue-600 bg-blue-50 px-3 py-2 rounded-lg font-medium">
                  <Search className="w-4 h-4" />
                  <span>Browse Intelligence</span>
                </a>
                <a href="/tools" className="flex items-center space-x-2 text-gray-600 hover:text-gray-900 font-medium">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <a href="/tools" className="bg-white rounded-xl p-6 border hover:shadow-lg transition-all cursor-pointer group block">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-12">
            ...
            <a href="/tools" className="bg-purple-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-purple-700 transition-colors">
              View All Tools
            </a>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="/tools" className="hover:text-white transition-colors">Featured</a></li>
                <li><a href="/tools" className="hover:text-white transition-colors">New Tools</a></li>
              </ul>
            </div>
